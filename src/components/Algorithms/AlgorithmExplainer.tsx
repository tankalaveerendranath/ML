...
import { ArrowLeft, Play, Pause, RotateCcw, CheckCircle, XCircle, Calculator, BookOpen } from 'lucide-react';
...
export const AlgorithmExplainer: React.FC<AlgorithmExplainerProps> = ({ algorithm, onBack }) => {
  ...
  const [showMathExample, setShowMathExample] = useState(false);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              {algorithm.mathematicalExample && (
                <button
                  onClick={() => setShowMathExample(!showMathExample)}
                ...
                >
                  ...
                  <span>Mathematical Example</span>
                </button>
              )}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {showMathExample && algorithm.mathematicalExample && (
          <MathematicalExample example={algorithm.mathematicalExample} />
        )}
